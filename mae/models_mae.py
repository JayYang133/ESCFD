...
class MaskedAutoencoderViT(nn.Module):
    ...
    """
    def __init__(self, img_size=8, patch_size=16, in_chans=2,
...
def mae_vit_large_patch4(**kwargs):
    model = MaskedAutoencoderViT(
...
mae_vit_base_patch4 = mae_vit_base_patch4
mae_vit_large_patch4 = mae_vit_large_patch4
mae_vit_base_patch8 = mae_vit_base_patch8
